...
// we can call via prototype, but if we try to call it directly, we get an error!
console.log("Manager.prototype.salary()", Manager.prototype.salary());
// console.log('Manager.prototype.salary()', Manager.salary())

//  If you don't call 'new', the first __proto__ will always be the instance of Function, without inheriting our classes.
// To access classes without new, you can access directly via prototype
console.log(
